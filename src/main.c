...
int main(void)
{
    ...
    // Get a dynamic 2D array desired_outputs
...
// Regard C as a function of the output activations aL
// C is the quadratic cost for a single training example
// Compute Total Cost
...
// Compute the partial derivatives ∂Cx/∂w and ∂Cx/∂b for a single training example
